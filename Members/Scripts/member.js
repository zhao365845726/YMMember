...
$(function () {
    ...
    $("#btnLogin").click(function () {
        var m_Tel = $("#InputTel").val();
        var m_Password = $("#InputPassword").val();
        if (m_Tel == "" || m_Tel == undefined) {
            alert("电话不能为空");
            return;
        }
        if (m_Password == "" || m_Password == undefined) {
            alert("密码不能为空");
            return;
        }
        localStorage.clear();
        localStorage.setItem("Tel", m_Tel);
        localStorage.setItem("Password", m_Password);
        submitData();
    });
...
function resetSubmitData() {
    if ($("#OldPassword") == "") {
        $("#tipInfo").addClass("alert alert-danger");
        $("#tipInfo").css("display", "");
        $("#tipInfo").text("旧密码不能为空");
        return;
    }else if ($("#NewPassword") == "") {
        $("#tipInfo").addClass("alert alert-danger");
        $("#tipInfo").css("display", "");
        ...
        return;
    }else if ($("#AgainNewPassword") == "") {
        $("#tipInfo").addClass("alert alert-danger");
        $("#tipInfo").css("display", "");
        $("#tipInfo").text("再次新密码不能为空");
        return;
    }
...
//失去焦点的时候根据不同条件显示不同的信息
function condition(c) {
    if (c.id == "OldPassword") {
        if (c.value != localStorage.getItem("Password")) {
            $("#tipInfo").addClass("alert alert-danger");
            $("#tipInfo").css("display", "");
            $("#tipInfo").text("旧密码输入不正确");
        } else {
            $("#tipInfo").css("display", "none");
            $("#tipInfo").text("");
        }
    } else if (c.id == "NewPassword") {
        if (c.value == localStorage.getItem("Password")) {
            $("#tipInfo").addClass("alert alert-danger");
            $("#tipInfo").css("display", "");
            $("#tipInfo").text("您输入的新密码与旧密码一致");
        } else {
            $("#tipInfo").css("display", "none");
            $("#tipInfo").text("");
        }
    } else if (c.id == "AgainNewPassword") {
        if (c.value != $("#NewPassword").val()) {
            $("#tipInfo").addClass("alert alert-danger");
            $("#tipInfo").css("display", "");
            $("#tipInfo").text("与新密码输入不一致");
        } else {
            $("#tipInfo").css("display", "none");
            $("#tipInfo").text("");
        }
